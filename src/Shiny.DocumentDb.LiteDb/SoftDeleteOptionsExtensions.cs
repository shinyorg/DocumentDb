...
/// <summary>Enables soft delete on <see cref="LiteDbDocumentStoreOptions"/> — see <see cref="SoftDelete"/>.</summary>
public static class LiteDbSoftDeleteOptionsExtensions
{
    /// <summary>
    ...
    /// </summary>
    public static LiteDbDocumentStoreOptions AddSoftDelete<T>(this LiteDbDocumentStoreOptions options, Expression<Func<T, object>> flagProperty) where T : class
    {
