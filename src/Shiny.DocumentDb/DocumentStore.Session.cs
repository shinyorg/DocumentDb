...
public partial class DocumentStore : Internal.IExplicitTransactionEngine
{
    /// <summary>
    ...
    /// </summary>
    async Task<ExplicitUnit> Internal.IExplicitTransactionEngine.BeginExplicitUnitAsync(CancellationToken ct)
    {
        if (this.sharedMode)
        {
