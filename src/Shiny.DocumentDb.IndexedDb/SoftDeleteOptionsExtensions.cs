...
/// <summary>Enables soft delete on <see cref="IndexedDbDocumentStoreOptions"/> — see <see cref="SoftDelete"/>.</summary>
public static class IndexedDbSoftDeleteOptionsExtensions
{
    /// <summary>
    ...
    /// </summary>
    public static IndexedDbDocumentStoreOptions AddSoftDelete<T>(this IndexedDbDocumentStoreOptions options, Expression<Func<T, object>> flagProperty) where T : class
    {
