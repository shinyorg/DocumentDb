...
{
    public static IServiceCollection AddMySqlDocumentStore(this IServiceCollection services, string connectionString)
    {
    ...
    public static IServiceCollection AddMySqlDocumentStore(this IServiceCollection services, Action<DocumentStoreOptions> configure)
    {
