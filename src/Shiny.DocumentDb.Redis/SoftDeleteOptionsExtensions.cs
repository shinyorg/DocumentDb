...
/// <summary>Enables soft delete on <see cref="RedisDocumentStoreOptions"/> — see <see cref="SoftDelete"/>.</summary>
public static class RedisSoftDeleteOptionsExtensions
{
    /// <summary>
    ...
    /// </summary>
    public static RedisDocumentStoreOptions AddSoftDelete<T>(this RedisDocumentStoreOptions options, Expression<Func<T, object>> flagProperty) where T : class
    {
