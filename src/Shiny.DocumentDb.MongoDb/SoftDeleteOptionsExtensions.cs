...
/// <summary>Enables soft delete on <see cref="MongoDbDocumentStoreOptions"/> — see <see cref="SoftDelete"/>.</summary>
public static class MongoDbSoftDeleteOptionsExtensions
{
    /// <summary>
    ...
    /// </summary>
    public static MongoDbDocumentStoreOptions AddSoftDelete<T>(this MongoDbDocumentStoreOptions options, Expression<Func<T, object>> flagProperty) where T : class
    {
