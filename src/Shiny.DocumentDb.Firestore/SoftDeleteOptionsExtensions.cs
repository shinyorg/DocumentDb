...
/// <summary>Enables soft delete on <see cref="FirestoreDocumentStoreOptions"/> — see <see cref="SoftDelete"/>.</summary>
public static class FirestoreSoftDeleteOptionsExtensions
{
    /// <summary>
    ...
    /// </summary>
    public static FirestoreDocumentStoreOptions AddSoftDelete<T>(this FirestoreDocumentStoreOptions options, Expression<Func<T, object>> flagProperty) where T : class
    {
