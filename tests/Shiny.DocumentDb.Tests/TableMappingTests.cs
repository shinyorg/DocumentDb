...
public abstract class TableMappingTestsBase : IDisposable
{
    ...
    // ── Custom ID property without table mapping (default shared table) ─────

    [Fact]
    public async Task MapIdProperty_OnDefaultTable_InsertAndGet()
    {
        var opts = new DocumentStoreOptions
        {
            DatabaseProvider = Fixture.CreateProvider(),
    ...
    [Fact]
    public async Task MapIdProperty_StringOverload_OnDefaultTable()
    {
        var opts = new DocumentStoreOptions
        {
            DatabaseProvider = Fixture.CreateProvider(),
    ...
    [Fact]
    public async Task MapIdProperty_GuidAutoGenerated_OnDefaultTable()
    {
        var opts = new DocumentStoreOptions
        {
            DatabaseProvider = Fixture.CreateProvider(),
    ...
    [Fact]
    public void MapIdProperty_FluentChaining()
    {
        var opts = new DocumentStoreOptions
        {
            DatabaseProvider = Fixture.CreateProvider()
