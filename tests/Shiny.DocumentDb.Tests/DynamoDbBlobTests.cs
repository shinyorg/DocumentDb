...
[Collection("DynamoDB")]
public class DynamoDbBlobTests : IDisposable
{
    readonly DynamoDbDatabaseFixture db;
    readonly string tableName;
    readonly DynamoDbDocumentStore store;

    public DynamoDbBlobTests(DynamoDbDatabaseFixture db)
    {
        this.db = db;
    ...
    {
        var bytes = Payload("dynamo blob payload");
